...
export default function Create() {
    ...
    const getActions = async () => {
        try {
            const { data } = await clientAxios.get(
                `/role-action/actions/${user.id}`
            );
            setActions(data);
            setFilteredActions(data); // Inicialmente muestra todas las acciones
        } catch (error) {
    ...
    const handleTypeChange = (e) => {
        ...
        if (selected) {
            ...
            setFilteredActions(actions); // Muestra todas las acciones si no se selecciona ningún tipo
        }
    };
        ...
        <>
            ...
            <div className="createRole">
                ...
                <p className="paragraph">
                    ...
                    donde el nombre rol es como se vera reflejado en el sistema
                    y finalmente selecciona las acciones que podrá hacer este
                    rol.
                </p>
